...
static bfd_boolean nds32_elf_ex9_replace_instruction (struct bfd_link_info *,
						      bfd *, asection *);
static bfd_boolean nds32_elf_ifc_calc (struct bfd_link_info *, bfd *, asection *);
  ...
  if (!h || (h->type != bfd_link_hash_defined && h->type != bfd_link_hash_defweak))
    {
      ...
      static const char sec_name[10][10] = {
	".data", ".sdata_d", ".sdata_w", ".sdata_h", ".sdata_b",
	...
	return FALSE;
      ...
      relax_omit_fp = table->relax_omit_fp;
      if (relax_omit_fp)
	{
			 ...
			 struct bfd_link_info *link_info, bfd_boolean *again)
{
  ...
  *again = FALSE;
  ...
  relax_omit_fp = table->relax_omit_fp;
  relax_reduce_fp_update = table->relax_reduce_fp_update;
  if (relax_omit_fp)
    {
      bfd_vma access_addr = 0;
      int fp_use = 0;
				   ...
				   bfd_boolean ifc_loop_aware)
{
  ...
  table->relax_omit_fp = relax_omit_fp;
  table->relax_reduce_fp_update = relax_reduce_fp_update;
