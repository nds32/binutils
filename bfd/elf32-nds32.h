...
void bfd_elf32_nds32_set_target_option (struct bfd_link_info *, int, int, int,
...
struct elf_nds32_link_hash_table
{
  ...
  int relax_omit_fp;            /* --mrelax-omit-fp  */
  int relax_reduce_fp_update;   /* --mrelax-reduce-fp-update  */
